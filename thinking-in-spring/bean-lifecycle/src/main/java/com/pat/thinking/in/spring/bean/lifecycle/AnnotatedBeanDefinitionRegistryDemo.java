 ...
 * @since
 */
public class AnnotatedBeanDefinitionRegistryDemo {
    public static void main(String[] args) {
        ...
        beanDefinitionReader.register(AnnotatedBeanDefinitionRegistryDemo.class);
        ...
        AnnotatedBeanDefinitionRegistryDemo demo = beanFactory.getBean("annotatedBeanDefinitionRegistryDemo", AnnotatedBeanDefinitionRegistryDemo.class);
